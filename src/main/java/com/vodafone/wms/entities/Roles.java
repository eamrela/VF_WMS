...
public class Roles implements Serializable {
    ...
    @JoinTable(name = "users_roles", joinColumns = {
        @JoinColumn(name = "role_id", referencedColumnName = "role_name")}, inverseJoinColumns = {
        @JoinColumn(name = "users_id", referencedColumnName = "user_email")})
    @ManyToMany
    ...
    public String toString() {
        return "com.vodafone.wms.entities.Roles[ roleName=" + roleName + " ]";
    }
